    ...
    <section class="flex flex-col w-full max-w-[1224px] mx-auto gap-8">
      <div class="flex flex-wrap gap-4 justify-center xl:justify-start">
        <header class="flex gap-4">
          <h2 class="font-bold text-2x1">Personagens</h2>
        ...
        <div class="flex flex-wrap gap-4 justify-center">
          <div v-for="currentCharacter of data.results"
            class="bg-[#313234] rounded-lg flex gap-4 flex-col p-4 w-full max-w-[294px]">
            <img :src="currentCharacter.image" height="200" width="262" class="rounded-2xl h-[200px] object-cover" />
            ...
            <NuxtLink :to="currentCharacter.url"
              class="self-end bg-[#11B0C8] flex gap-2 py-[6px] pl-1 pr-2 rounded-[32px] text-se items-center mt-auto"
              target="_blank">
              <IconsInfo />
              Saiba Mais
            </NuxtLink>
